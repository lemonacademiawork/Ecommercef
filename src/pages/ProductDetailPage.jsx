...
export function ProductDetailPage({
  ...
  const productSchema = {
    ...
    "name": product.name,
    "image": productImages,
    "description": product.description || `Buy ${product.name} at Lemon House. High quality craft supplies and DIY materials.`,
    "sku": product.id || String(productId),
    "brand": {
      "@type": "Brand",
      "name": "Lemon House"
    },
    "offers": {
      "@type": "Offer",
      "url": typeof window !== "undefined" ? window.location.href : `https://lemonhousecraft.in/product/${productId}`,
      "priceCurrency": "INR",
