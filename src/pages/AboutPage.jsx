  ...
  const team = [
    {
      ...
      role: "Founder & CEO",
      emoji: "👩‍💼",
      bio: "Craft enthusiast turned entrepreneur. Passionate about making quality supplies accessible to everyone.",
    },
    {
      name: "Rohan Kumar",
      role: "Head of Operations",
      emoji: "👨‍💻",
      bio: "Logistics wizard who ensures your orders reach you faster than you can tie a knot.",
    },
    {
      name: "Sneha Iyer",
      role: "Creative Director",
      emoji: "🎨",
      bio: "Artist and crafter who curates every product in our catalog with love and expertise.",
    },
    {
      name: "Arjun Sharma",
      role: "Community Manager",
      emoji: "🌟",
      bio: "Connects crafters across India and fosters the vibrant Lemon House community.",
    },
  ];
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8">
            <div
              className="p-8 rounded-3xl border-2 border-primary/20"
            ...
            >
              ...
              <p className="text-foreground/70 leading-relaxed">
                To make premium craft supplies accessible, affordable, and
                inspiring for every crafter in India — from the beginner
                discovering their first hobby to the professional artisan
                building a business.
              </p>
            </div>
            <div
              className="p-8 rounded-3xl border-2 border-accent/20"
            ...
            >
              ...
              <p className="text-foreground/70 leading-relaxed">
                A world where creativity knows no boundaries — where every
                person has access to the tools, materials, and community they
                need to bring their creative vision to life.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-14 bg-white text-center">
        <div className="max-w-xl mx-auto px-4">
          ...
          <p className="text-muted-foreground mb-6">
            Thousands of crafters are creating beautiful things every day. Be
            part of our story.
          </p>
          <button
